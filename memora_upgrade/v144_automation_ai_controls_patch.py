...
# More UI features are applied here at the end of the existing patch chain.

# --- AI service: global cascade Gemini -> OpenAI -> Ollama -> on-phone model ---
...
# --- AI Settings: every task configurable, Gemini on fresh install ---
...
# --- Exams: AI remains primary; cards are only fallback and are now fully random ---
...
# --- Tutor prompt generator from description ---
...
# --- Agent prompt generator from a user description ---
