...
subprocess.run(['python3', 'v178_formula_card_ai_guard_patch.py'], check=True)
print('v161 applied: v159 source repaired; directory generated; v160-v178 fixes applied')
