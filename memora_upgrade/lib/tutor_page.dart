...
class _TutorPageState extends State<TutorPage> {
  ...
  List<StudyGuide> get activeGuides => widget.store.guides
      .where((g) => activeTutor.guideIds.contains(g.id))
      .toList();
              ...
              children: [
                ...
                Expanded(
                  child: widget.store.guides.isEmpty
                      ? const Center(
                          child: Text('Primero añade o crea guías en Biblioteca.'),
                        )
                      : ListView(
                          children: [
  ...
  Future<void> _ask() async {
    ...
    if (guides.isEmpty) {
      setState(() => answer =
          'Asigna al menos una guía a ${activeTutor.name} antes de preguntar.');
      return;
    }
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  minLines: 2,
                  maxLines: 3,
                  decoration: const InputDecoration(labelText: 'Descripción / estilo'),
                ),
                const SizedBox(height: 10),
                TextField(
                  ...
                  maxLines: 7,
                  decoration:
                      const InputDecoration(labelText: 'Prompt / instrucciones del tutor'),
                ),
                ...
                Navigator.pop(
                  ...
                  TutorProfile(
                    ...
                    instructions: instructions.text.trim().isEmpty
                        ? 'Explica con claridad y adapta la enseñanza.'
                        : instructions.text.trim(),
                    modelSource: source,
                    recommendedModels: models.text
                        .split('\n')
                        .map((e) => e.trim())
                ...
                child: ListView(
                  children: [
                    for (final tutor in tutors)
                      ListTile(
                        leading:
                            Text(tutor.emoji, style: const TextStyle(fontSize: 26)),
                        title: Text(tutor.name),
                        subtitle: Text(
                          '${_sourceLabel(tutor.modelSource)} • ${tutor.guideIds.length} guía(s)',
                        ),
                ...
                children: [
                  ...
                  Card(
                    child: ExpansionTile(
                      ...
                      title: const Text('Modelos recomendados'),
                      subtitle: Text(
                        globalLocalModel.isEmpty
                            ? 'Toca uno para usarlo como modelo general Ollama'
                            : 'Modelo general Ollama: $globalLocalModel',
                      ),
                      ...
                      children: [
                        for (final model in activeTutor.recommendedModels)
                          ListTile(
                            ...
                            title: Text(model),
                            trailing: _modelTag(model) == globalLocalModel
                                ? const Icon(Icons.check_circle)
                        ...
                        const Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              'El selector cambia el modelo general de Ollama; no descarga el modelo automáticamente.',
                            ),
                          ),
                        ),
                        OutlinedButton.icon(
                          ...
                          icon: const Icon(Icons.tune),
                          label: const Text('Editar tutor / recomendaciones'),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: ExpansionTile(
                      ...
                      children: [
                        if (activeGuides.isEmpty)
                          const Align(
                            alignment: Alignment.centerLeft,
                            child: Text('Todavía no tiene guías asignadas.'),
                          ),
                        ...
                        OutlinedButton.icon(
                          ...
                          label: const Text('Asignar / quitar guías'),
                        ),
                      ],
                    ),
                  ),
