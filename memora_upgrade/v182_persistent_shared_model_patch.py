...
# v182: make shared GGUF selection durable across restarts/background work.
...
if start < 0 or end < 0:
    raise SystemExit('v182 shared picker method anchors missing')
...
print('v182 applied: shared GGUF paths are durable across restarts/background work')
